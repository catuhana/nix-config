...
- [ ] Add like an option or something to `mkSystem` that tells which kind of a system we're building, e.g. laptop, desktop, server etc. and make some services like `sched-ext` only be enabled on only specified kinds.
